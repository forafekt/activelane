...
export interface WorkbenchActionContribution extends WorkbenchContributionBase {
  ...
  icon?: WorkbenchComponent | string | any // TODO: remove any
  commandId: string
}
...
export interface OpenWorkbenchTabOptions {
  ...
  icon?: WorkbenchComponent | any // TODO
  surfaceId?: string
  surface?: WorkbenchSurfaceDescriptor
  closable?: boolean
  pinned?: boolean
...
export interface WorkbenchSettingsPageContribution extends WorkbenchContributionBase {
  component: WorkbenchComponent
  // biome-ignore lint/suspicious/noExplicitAny:  TODO should be WorkbenchComponent
  icon?: WorkbenchComponent | string | any // TODO should be WorkbenchComponent
  section?: string
}
