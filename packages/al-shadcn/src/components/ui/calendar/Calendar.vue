...
import { NativeSelect, NativeSelectOption } from '../native-select/index'
  ...
  >
    <CalendarHeader class="pt-0">
      <nav class="flex items-center gap-1 absolute top-0 inset-x-0 justify-between">
        <CalendarPrevButton> <slot name="calendar-prev-icon" /> </CalendarPrevButton>
        <CalendarNextButton> <slot name="calendar-next-icon" /> </CalendarNextButton>
      </nav>
      ...
      >
        ...
        <template v-else> <CalendarHeading /> </template>
      </slot>
    </CalendarHeader>
